...
// Light attributes
glm::vec3 lightPos(0.5f, 0.5f, 2.5f);   // posición de la fuente de luz
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.9f, 0.9f, 0.9f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.7f, 0.6f, 0.6f);
